/**
 * Service Management framework fallback
...
/**
 * Service Management framework registration implementation
 */
export class LoginItemServiceMgmt {
  private registrations: Map<string, { path: string; timestamp: string }> = new Map();

  /**
   * Register a login item using Service Management framework
   */
