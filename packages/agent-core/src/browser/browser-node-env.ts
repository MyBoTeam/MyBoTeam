/**
 * Browser server Node.js environment helpers
 *
 * Utilities for building spawn environments, resolving Node.js/Playwright
 * executable paths, installing Playwright, and waiting for the dev-browser server.
 */
