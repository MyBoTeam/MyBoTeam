...
export const WHATSAPP_BEHAVIOR = `- If the user asks to "send a message to [person]" without naming a platform and both Slack and WhatsApp are connected, ask "Which platform — Slack or WhatsApp?" before sending anything — never guess
