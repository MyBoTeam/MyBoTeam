...
Connects to the dev-browser HTTP server, which manages browser lifecycle and page routing. This is how the MyBoTeam desktop app uses it.
...
| `MYBOTEAM_TASK_ID` | both    | Task ID for page name isolation (default: `default`).         |
