...
packages/agent-core/     # Core business logic, shared types, MCP tools (published as @myboteam/agent-core)
```

- `index.ts` - Electron bootstrap, single-instance enforcement, `myboteam://` protocol handler
