# MyBoTeam — Dev Mode Process Architecture
...
flowchart TB
    ...
    dev_cjs -- "spawn: pnpm -F @myboteam/web dev" --> vite_proc
    dev_cjs -- "spawn (after :5173 ready): pnpm -F @myboteam/desktop dev" --> electron_proc
