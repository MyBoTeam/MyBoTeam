...
export function FollowUpInput(props: FollowUpInputProps) {
  ...
  return (
    <div
      className="flex-1 flex-shrink-0 px-6 py-4 relative"
      onDragEnter={(e) => {
        e.preventDefault();
        e.stopPropagation();
    ...
    >
      ...
      <div className="mx-auto space-y-2">
        ...
        <div className="rounded-xl border border-border bg-card/70 shadow-sm transition-all duration-200 focus-within:border-ring focus-within:ring-1 focus-within:ring-ring">
