import type { ConnectedProvider } from '@myboteam/agent-core';
...
export function CopilotProviderForm({
  ...
  return (
    ...
    >
      <ProviderFormHeader
        logoSrc={logoSrc}
        providerName={t('providers.copilot', {
            ...
            {userCode && verificationUri && (
              <div className="rounded-lg border border-border bg-muted/50 p-4 space-y-2">
                <p className="text-sm font-medium text-foreground">
                  {t('copilot.enterCode', {
                    defaultValue: 'Enter this code on GitHub:',
                  })}
                </p>
