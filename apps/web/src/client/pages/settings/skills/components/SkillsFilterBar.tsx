  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button className="flex w-[150px] items-center justify-between gap-1.5 rounded-lg border border-border bg-card/70 px-3 py-2 text-[13px] font-medium text-foreground transition-colors hover:bg-muted">
