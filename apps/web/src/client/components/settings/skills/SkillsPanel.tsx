    ...
    <div className="flex flex-col">
      ...
      <div className="mb-4 flex gap-3">
        ...
        <motion.button
          ...
          className="flex items-center justify-center rounded-lg border border-border bg-card/70 p-2 text-muted-foreground transition-colors hover:bg-muted hover:text-foreground disabled:opacity-50"
