...
describe('TaskHistory Integration', () => {
  ...
  describe('empty state rendering', () => {
    ...
    it('should render helpful message in empty state', () => {
      ...
      // Assert
      expect(screen.getByText(/start by describing what you want to achieve/i)).toBeInTheDocument();
    });
  ...
  describe('styling and layout', () => {
    it('should render tasks with card styling', () => {
      ...
      // Assert
      const taskCard = screen.getByText('Styled task').closest('[class*="rounded-card"]');
    ...
    it('should render tasks with hover effect', () => {
      ...
      // Assert
      const taskCard = screen.getByText('Hover task').closest('[class*="hover:shadow-card-hover"]');
