...
describe('useTheme hook', () => {
  beforeEach(() => {
    ...
    mockGetThemeColor.mockResolvedValue('neutral');
    mockSetThemeColor.mockResolvedValue(undefined);
  });
  ...
  describe('initial theme detection', () => {
    it('should default isDark=false when no saved preference and system is light', async () => {
      ...
      expect(result.current).toHaveProperty('themeColor');
      expect(result.current).toHaveProperty('changeThemeColor');
    });
  ...
  describe('toggleTheme()', () => {
    ...
    it('should call myboteam.setTheme with the new preference after toggle', async () => {
      mockMatchMedia(false);
