...
import type { SettingsChangePayload, SettingsService } from './settings-service.js';
import type { SkillsService } from './skills-service.js';
import type { StorageService } from './storage-service.js';
import type { TaskService } from './task-service.js';
import type { WhatsAppDaemonService } from './whatsapp-service.js';
import type { WorkspaceChangePayload, WorkspaceService } from './workspace-service.js';
...
export function registerRpcMethods(services: RouteServices): void {
  ...
  rpc.registerMethod(
    ...
    safeHandler(async () => {
      return myboteamRuntime.getUsage();
    }),
  );
