 ...
 * of auxiliary stores (HuggingFace Local config, MyBoTeam AI credits cache).
 *
 ...
 * `@myboteam/agent-core` (`common/types/daemon.ts`) so both daemon and
