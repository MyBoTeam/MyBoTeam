...
export default defineConfig({
  ...
  splitting: false,
  sourcemap: true,
  // sql.js is WASM-based (not native), but the `.wasm` file is loaded at
  // runtime via locateFile. Keep it bundled; the WASM is resolved from
  // node_modules/sql.js/dist/ during development and needs explicit copying
  // in packaged builds.
  external: [
