...
// value imports from `@myboteam/agent-core` → `@myboteam/agent-core/desktop-main`.
...
// Mock @myboteam/agent-core - comprehensive mock covering all exports used by handlers.ts
