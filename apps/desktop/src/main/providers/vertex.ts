...
import type { VertexCredentials } from '@myboteam/agent-core/desktop-main';
import { fetchVertexModels, validateVertexCredentials } from '@myboteam/agent-core/desktop-main';
