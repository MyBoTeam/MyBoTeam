import type { BedrockCredentials } from '@myboteam/agent-core/desktop-main';
import { fetchBedrockModels, validateBedrockCredentials } from '@myboteam/agent-core/desktop-main';
import type { IpcMainInvokeEvent } from 'electron';
import { getLogCollector } from '../../../logging';
import { getApiKey, storeApiKey } from '../../../store/secureStorage';
