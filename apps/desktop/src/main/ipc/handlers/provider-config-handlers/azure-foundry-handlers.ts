import type { AzureFoundryConfig } from '@myboteam/agent-core/desktop-main';
import { testAzureFoundryConnection, validateHttpUrl } from '@myboteam/agent-core/desktop-main';
