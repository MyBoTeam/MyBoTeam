...
**Problem/Opportunity:**
Targeting "non-technical users" is too broad to drive product decisions. A clear primary persona
...
#### Option A: Knowledge Worker / Professional
...
**Decision Statement:**
The core application will be free forever, including the Orchestrator, the Secretary
and Accountant agents, and basic shared tools. Revenue will come from selling tailor-made agent
...
- Risk that users never convert to paid solutions — mitigated by making free tier
  compelling but limited (2 agents, basic tools only; advanced MCP servers and custom
  solutions are paid)
