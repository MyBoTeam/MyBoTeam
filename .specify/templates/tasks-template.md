...
**Tests**: Behavior changes MUST include relevant automated tests before or
alongside implementation. If automated tests are not practical, include a task
that records the exception, alternate verification, and reviewer approval needed.
...
- [ ] T010 Define secret handling and local-first data boundaries
- [ ] T011 Define observability events/logs without exposing secrets
...
> **NOTE: Write relevant tests FIRST, ensure they FAIL before implementation.
> If tests are not practical, add a justified verification exception task.**
...
- [ ] T019 [US1] Add non-secret logging/events for user story 1 operations
...
- [ ] TXXX Observability review: logs/events/traces are useful and contain no secrets
- [ ] TXXX Constitution compliance review and documented verification results
...
- Tests MUST be written and FAIL before implementation unless a documented
  exception task records alternate verification and reviewer approval
