...
**Tests are REQUIRED for behavior changes**: Generate relevant test tasks before
implementation tasks. If automated tests are not practical, generate an explicit
verification-exception task that records the reason, alternate verification, and
