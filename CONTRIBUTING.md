# Contributing to MyBoTeam

Thank you for your interest in contributing to MyBoTeam! This document provides guidelines and instructions for contributing.

## Getting Started

1. Fork the repository
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/mybotearn.git`
...
```bash
pnpm -F @myboteam/web test                    # Run all web tests
pnpm -F @myboteam/web test:unit               # Unit tests only
pnpm -F @myboteam/web test:integration        # Integration tests only
```

### Desktop App (apps/desktop)

```bash
pnpm -F @myboteam/desktop test                # Run all desktop tests
...
```bash
pnpm -F @myboteam/agent-core test          # Run core tests
```
